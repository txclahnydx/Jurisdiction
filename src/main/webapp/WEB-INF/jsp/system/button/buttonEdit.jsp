	...
	<table width="100%">
		<tr>
			...
			<td>
				...
				<input class="easyui-validatebox" type="text" name="name" value="${button.name }" data-options="required:true" />
			</td>
		</tr>
		<tr>
			<td>Field:</td>
			<td><input class="easyui-validatebox" type="text" name="field" value="${button.field }" data-options="required:true" /></td>
		</tr>
		<tr>
			<td>是否启用：</td>
			<td colspan="3">
				<c:if test="${button.status==0 }">
				...
				<c:if test="${button.status==1 }">
					<input type="radio" name="status" value="0" style="vertical-align:middle;"/>
					<label>启用</label>
					<input type="radio" name="status" value="1" checked="checked" style="vertical-align:middle;"/>
					<label>不启用</label>
				</c:if>
			</td>
		</tr>
